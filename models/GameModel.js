...
const gameSchema = new mongoose.Schema(
    {
        ...
        AppStoreUrl: { type: String, required: false, lowercase: false, trim: true },
        GooglePlayUrl: { type: String, required: false, lowercase: false, trim: true },
        SteamUrl: { type: String, required: false, lowercase: false, trim: true },
        ItchIOUrl: { type: String, required: false, lowercase: false, trim: true },
